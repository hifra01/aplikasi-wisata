from views.interfaces_admin import listSemuaOrder
from pubsub import pub


class ListAllOrderFrame(listSemuaOrder):
    order_id_list = []
    selected_index = None
    ...
    def __init__(self, data, parent=None):
        ...
        pub.subscribe(self.refresh_list, "refresh_all_order_list")
    ...
    def btn_search_onclick(self, event):
        ...
        pub.sendMessage("search_all_order", search=search)
        pass

    def btn_detail_onclick(self, event):
        pub.sendMessage("show_order_detail", order_id=self.order_id_list[self.selected_index], parent=self)
        pass
