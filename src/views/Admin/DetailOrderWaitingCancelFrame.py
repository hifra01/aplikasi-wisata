from views.interfaces_admin import detailVerifikasiPembatalan
from pubsub import pub


class DetailOrderWaitingCancelFrame(detailVerifikasiPembatalan):
    ...
    def btn_cancel_order_onclick(self, event):
        ...
        pub.sendMessage("cancel_order", data=data)
